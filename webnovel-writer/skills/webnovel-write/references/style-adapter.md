...
## 硬约束（必须）
- ✅ 句子长短服从自然口气，不机械切短也不故意拉长
- ✅ 抽象判断 → 动作/反应/代价
- ✅ 删除“总结式旁白”和大段纯解释
- ✅ 章内至少有 1 个明确推进点（信息/行动/关系/局势其一）

> **兼容性说明**：若项目本地 `preferences.json` 或 `设定集/写作风格.md` 与本文件冲突，以项目本地文件为准。
...
| 句子自然度 | 念出来顺口，不拗口 | 重写拗口句 |
| 解释段 | 无连续大段纯解释 | 打散或删除 |

> **注意**：不强制执行字数/比例类规则（如”>40字句子<10%”），以项目本地 `preferences.json` 的”念出来顺口”为准。
